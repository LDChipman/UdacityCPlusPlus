...
int main() {
  unordered_map<int, string> phoneCodes = {
      {972, "Israel"},
      {93, "Afghanistan"},
      {355, "Albania"},
      {213, "Algeria"},
  ...
  if (phoneCodes.find(960) == phoneCodes.end()) {
    phoneCodes.insert({960, "Maldives"});
  }

  cout << "The country to whom the phone code 960 belongs to is: "
       << phoneCodes[960] << "\n";
}